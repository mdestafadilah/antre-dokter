...
export const queueAPI = {
  ...
  updateQueueStatus: (queueId, data) =>
    api.patch(`/queue/update-status/${queueId}`, data),
  getQueuesByDate: (date) => api.get(`/queue/by-date?date=${date}`),
  getReportsByDateRange: (startDate, endDate) =>
    api.get(`/queue/reports?startDate=${startDate}&endDate=${endDate}`),
};
...
export const emergencyAPI = {
  ...
  checkEmergencyClosure: (date) =>
    api.get(`/emergency/check-closure?date=${date}`),
  rescheduleAffectedQueues: (data) => api.post("/emergency/reschedule", data),
  deactivateEmergencyClosure: (emergencyClosureId) =>
    api.patch(`/emergency/closure/${emergencyClosureId}/deactivate`),
};
...
export const notificationAPI = {
  ...
  respondToRescheduleRequest: (requestId, data) =>
    api.post(`/notifications/reschedule/${requestId}/respond`, data),
};
